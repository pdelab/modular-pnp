...
public:
                               ...
                               int cell_orientation) const
  {
    ...
    const double G0_1_0_0 = det*w[0][1]*(K[0]*K[0]);
    const double G1_0_0_0 = det*w[0][0]*(K[0]*K[0]);
    const double G1_0_1_0 = det*w[0][1]*(K[0]*K[0]);
    
    // Compute element tensor
    A[0] = G0_0_0_0 - G0_1_0_0 + G1_0_0_0 + G1_0_1_0;
    A[1] = G0_0_0_0 - G0_1_0_0 - G1_0_0_0 - G1_0_1_0;
    A[2] = -G0_0_0_0 + G0_1_0_0 - G1_0_0_0 - G1_0_1_0;
    A[3] = -G0_0_0_0 + G0_1_0_0 + G1_0_0_0 + G1_0_1_0;
  }
                               ...
                               int cell_orientation) const
  {
    ...
    for (unsigned int ip = 0; ip < 2; ip++)
    {
      ...
      for (unsigned int j = 0; j < 2; j++)
      {
        ...
        A[j] += (FE0[ip][j]*I[0] + FE0_D1[ip][j]*I[1]);
      } // end loop over 'j'
    } // end loop over 'ip'
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "9048e52f5556d96354d278df8c12f33d52e89dca719166528cb112fdbf811821151d43eac7090273f378cce9e109bd7e13b7a5efe47e45f354df97371e67e6fd";
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "b71d67952c21b5db5d7d62e1530d626f2a017fbb3533f4594654995879a09f0e5d08e82bc690b74e06b92d0d83e05e791a16b2a448534db72903079f53c155b0";
  }
...
public:
  ...
  // Constructor
  Form_a(const dolfin::FunctionSpace& V1, const dolfin::FunctionSpace& V0, const dolfin::GenericFunction& u):
    dolfin::Form(2, 1), u(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
    _function_spaces[1] = reference_to_no_delete_pointer(V1);
  ...
  // Constructor
  Form_a(const dolfin::FunctionSpace& V1, const dolfin::FunctionSpace& V0, std::shared_ptr<const dolfin::GenericFunction> u):
    dolfin::Form(2, 1), u(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
    _function_spaces[1] = reference_to_no_delete_pointer(V1);
  ...
  // Constructor
  Form_a(std::shared_ptr<const dolfin::FunctionSpace> V1, std::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::GenericFunction& u):
    dolfin::Form(2, 1), u(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
  ...
  // Constructor
  Form_a(std::shared_ptr<const dolfin::FunctionSpace> V1, std::shared_ptr<const dolfin::FunctionSpace> V0, std::shared_ptr<const dolfin::GenericFunction> u):
    dolfin::Form(2, 1), u(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
...
public:
  ...
  // Constructor
  Form_L(const dolfin::FunctionSpace& V0, const dolfin::GenericFunction& u, const dolfin::GenericFunction& f):
    dolfin::Form(1, 2), u(*this, 0), f(*this, 1)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_L(const dolfin::FunctionSpace& V0, std::shared_ptr<const dolfin::GenericFunction> u, std::shared_ptr<const dolfin::GenericFunction> f):
    dolfin::Form(1, 2), u(*this, 0), f(*this, 1)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_L(std::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::GenericFunction& u, const dolfin::GenericFunction& f):
    dolfin::Form(1, 2), u(*this, 0), f(*this, 1)
  {
    _function_spaces[0] = V0;
  ...
  // Constructor
  Form_L(std::shared_ptr<const dolfin::FunctionSpace> V0, std::shared_ptr<const dolfin::GenericFunction> u, std::shared_ptr<const dolfin::GenericFunction> f):
    dolfin::Form(1, 2), u(*this, 0), f(*this, 1)
  {
    _function_spaces[0] = V0;
