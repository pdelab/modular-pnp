...
int main(int argc, char** argv)
{
  ...
  // interpolate
  auto V= std::make_shared<pnp_stokes_battery::FunctionSpace>(mesh);
  ...
  pnp_stokes_battery::BilinearForm a(V,V);
  pnp_stokes_battery::LinearForm L(V);
  a.eps = eps; L.eps = eps;
  a.Dp = Dp; L.Dp = Dp;
  a.Dn = Dn; L.Dn = Dn;
  a.qp = qp; L.qp = qp;
